...
#                     class_name = element_obj.find('name').text
#                     if class_name == "WBC":
#                         if '1' not in classes_count:
#                             classes_count['1'] =1
#                         else:
#                             classes_count['1'] += 1
#                         if class_name not in class_mapping:
#                             class_mapping['1'] = len(class_mapping)
#                         obj_bbox = element_obj.find('bndbox')
#                         x1 = int(round(float(obj_bbox.find('xmin').text)))
#                         y1 = int(round(float(obj_bbox.find('ymin').text)))
#                         x2 = int(round(float(obj_bbox.find('xmax').text)))
...
#                         difficulty = int(element_obj.find('difficult').text) == 1
#                         annotation_data['bboxes'].append(
#                             {'class': '1', 'x1': x1, 'x2': x2, 'y1': y1, 'y2': y2, 'difficult': difficulty})
#                     if class_name == "RBC":
#                         if '0' not in classes_count:
#                             classes_count['0'] =1
#                         else:
#                             classes_count['0'] += 1
#                         if class_name not in class_mapping:
#                             class_mapping['0'] = len(class_mapping)
#                         obj_bbox = element_obj.find('bndbox')
#                         x1 = int(round(float(obj_bbox.find('xmin').text)))
#                         y1 = int(round(float(obj_bbox.find('ymin').text)))
#                         x2 = int(round(float(obj_bbox.find('xmax').text)))
...
#                         difficulty = int(element_obj.find('difficult').text) == 1
#                         annotation_data['bboxes'].append(
#                             {'class': '0', 'x1': x1, 'x2': x2, 'y1': y1, 'y2': y2, 'difficult': difficulty})
#                     if class_name == "Platelets":
#                         if '2' not in classes_count:
#                             classes_count['2'] =1
#                         else:
#                             classes_count['2'] += 1
#                         if class_name not in class_mapping:
#                             class_mapping['2'] = len(class_mapping)
#                         obj_bbox = element_obj.find('bndbox')
#                         x1 = int(round(float(obj_bbox.find('xmin').text)))
#                         y1 = int(round(float(obj_bbox.find('ymin').text)))
#                         x2 = int(round(float(obj_bbox.find('xmax').text)))
...
#                         difficulty = int(element_obj.find('difficult').text) == 1
#                         annotation_data['bboxes'].append(
#                             {'class': '2', 'x1': x1, 'x2': x2, 'y1': y1, 'y2': y2, 'difficult': difficulty})
